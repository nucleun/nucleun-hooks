...
/***/ function(module, exports) {
	...
	var Hooks = function () {
	  function Hooks(subject) {
	    ...
	    subject.$pre = {};
	    subject.$post = {};
	    this.subject = Object.getOwnPropertyNames(subject).filter(function (a) {
	      return (/^(?!data)/.test(a)
	      );
	    }).reduce(function (a, b) {
	      return Object.assign(a, _defineProperty({}, b, subject[b]));
	    }, subject);
	  }
	  ...
	  _createClass(Hooks, [{
	    ...
	    key: '_trigger',
	    value: function _trigger(type, action) {
	      var _this = this,
	          _arguments = arguments;
	
	      (this.subject[type][action] || []).map(function (hook) {
	        return hook.apply(_this.subject, [].slice.call(_arguments, 2));
	      });
	    }
	  }, {
	    key: '_wrap',
